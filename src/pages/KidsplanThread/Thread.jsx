...
const Thread = () => {
  ...
  const fromToChat = useSelector((state) => state?.user?.fromToChat);
  ...
  const handleSendMessage = async ({
    ...
    if (attachmentFiles?.length > 0) {
      ...
      if (!fileUploadResult.success) {
        showToast("error", languageTranslatorUtil(language,"toastMessages","staticErrors","uploadAttachmentFailure"));
      } else {
  ...
  const fetchAllUserThreads = async (
    ...
    try {
      ...
      showToast("error", languageTranslatorUtil(language,"toastMessages","staticErrors","fetchingThreadsFailure"));
    }
  };
  ...
  const fetchUserThreadChatsMethod = async (
    ...
    try {
      ...
      showToast("error", languageTranslatorUtil(language,"toastMessages","staticErrors","fetchingChatsFailure"));
    }
  };
          ...
          >
            <div className="px-6">
              {/* <div className="flex items-center justify-between mt-[24px] mb-[36px]">
                <h1 className="text-xl font-semibold text-dark-black font-roboto">
                  {languageTranslatorUtil(language,"chat_page","messagesLabel")}
                </h1>
              </div> */}
              <div className="flex items-center justify-between mt-[24px] mb-[36px]">
                  <div className="flex flex-row text-xl font-semibold text-dark-black font-inter">
                      ...
                      >
                              <FaArrowLeft  size={20} className="text-primary cursor-pointer"/>
                      </span>
