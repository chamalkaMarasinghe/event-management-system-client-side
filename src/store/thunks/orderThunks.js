...
export const createSubscriptionCheckoutWithP24 = createAsyncThunk("order/createSubscriptionCheckoutWithP24", async ({eventId}) => {
  const response = await api.post("order/create-payment-intent-p24", {eventId});
  return response.data;
});