...
export default function ErrorOccurPage() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center justify-center min-h-screen gap-y-8 px-12 md:px-20 py-10 bg-white w-full">
                ...
                <div className="w-full md:w-[784px] flex flex-col items-center">
                    ...
                    >
                        <LazyLoadImage
                            ...
                            alt="Error Occurred"
                            className="w-full h-full object-contain" // Fill the container
