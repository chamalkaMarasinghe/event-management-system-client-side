...
const DropDownNew = ({
  ...
  const getDisplayValue = (option) => {
    ...
    return languageTranslatorUtil(language, "common_stringTemplates", "dropdown", `${displayValue}`) || displayValue;
  };
                ...
                >
                  ...
                  {filteredOptions.length === 0 && (
                      <div className="px-4 py-2 font-medium text-center text-gray-500 font-inter">
                          {languageTranslatorUtil(language,"ms_values","noResultsFound")}
                      </div>
                  )}
                </div>
              </div>
