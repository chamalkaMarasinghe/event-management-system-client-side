      ...
      if (result?.success) {
        showToast(
          ...
          result?.response?.message ||
            languageTranslatorUtil(language,"ms_values","pwResetLinkSent")
        );
      } else {
        showToast("error", result?.response?.message || languageTranslatorUtil(language,"toastMessages","staticErrors","pwResetLinkSendFailure"));
      }
    }
  }; 
