...
const CustomButton = ({
                          ...
                          bgColor = "bg-primary",
                          textColor = "text-white",
                          hoverBgColor = "hover:bg-primary-dark", // Add hover background color prop
                          hoverTextColor = "hover:text-white", // Add hover text color prop
                          width = "w-full",
                          height = "h-12",
                          borderColor = "border-transparent",
                          hoverBorderColor = "hover:border-transparent", // Add hover border color prop
                          icon,
                          iconPosition = "left",
                          loading = false,
                          pulse = false,
    ...
    return (
        <button
            className={twMerge(
                ...
                hoverBorderColor,
                className,
                rest.disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:opacity-90' // Added hover opacity for better effect
            )}
            {...rest}
        >
            {loading ? (
                ...
                <>
                    {icon && iconPosition === "left" && icon}
                    <span className={`${textWeight} hover:inherit`}>{buttonText}</span>
                    {icon && iconPosition === "right" && icon}
                </>
            )}
        </button>
