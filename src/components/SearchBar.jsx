      ...
      >
        ...
        <div className="relative">
          ...
          <input
            ...
            className={twMerge(
              `w-full h-12 ${searchIcon || icon ? 'pl-10 pr-4' : 'px-4'} rounded-lg border text-sm placeholder:text-content placeholder:text-opacity-50 font-inter focus:outline-none ${className} 
              ${allowFillColor && value ? "bg-[#E0F2F1] bg-opacity-[30%]" : ""}
              ${getBorderClasses()}`,
              inputStyle
            )}
